...
@Component({
  selector: 'page-profileutility',
  templateUrl: 'profileutility.html',
})
...
loginid			=	'';
  ...
  ionViewDidLoad() {
			...
			this.customerdata	=	this.tokenvalues[0].accesstok;
				...
				var url	=	this.customerdata['base_url']+'ws/luwebservicemobile.asmx/GetAccountUtlitiesList?wskey=59eeb7e2ecbb5e67b9600316d2987896&accountnumber='
